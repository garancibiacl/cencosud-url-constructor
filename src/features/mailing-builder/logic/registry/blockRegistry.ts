...
export const blockRegistry: BlockRegistryMap = {
  ...
  "product-dd": defineBlock<ProductDdBlock>({
    ...
    defaultProps: {
      imageUrl:        "",
      discountLabel:   "¡Sólo X pocos días!",
      discountBadgeBg: "#FFD600",
      discountBadgeFg: "#000000",
      badgeTop:        10,
      badgeLeft:       50,
      badgeFontSize:   12,
      ...
      discountNumber:      "30",
      discountNumberColor: "#ffffff",
      discountSymbol:      "%",
      discountSymbolColor: "#ffffff",
      discountText:        "DCTO.",
      discountTextColor:   "#ffffff",
      ofertaShow:          true,
      ofertaLabel:         "",
      ofertaLabelFg:       "#1a5c2a",
      ofertaLogoUrl:       "/oferta-cenco.webp",
      ofertaLogoSize:      80,
      ofertaBg:            "transparent",
      ofertaBorderRadius:  6,
    },
    ...
    renderHtml: (block, doc) => {
      ...
      return productDdTemplate({
        ...
        ofertaLabel:         escapeHtml(block.props.ofertaLabel ?? "Oferta"),
        ofertaLabelFg:       block.props.ofertaLabelFg ?? "#1a5c2a",
        ofertaLogoUrl:       escapeHtml(block.props.ofertaLogoUrl ?? ""),
        ofertaLogoSize:      block.props.ofertaLogoSize ?? 60,
        ofertaBg:            block.props.ofertaBg ?? "#ffffff",
