    ...
    <div className="flex min-h-screen items-center justify-center bg-sidebar px-4 text-sidebar-foreground">
      <Card className="w-full max-w-md border-white/10 bg-white/10 shadow-elevated backdrop-blur-xl">
        <CardHeader className="items-center space-y-3 pb-2">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-warning/20 ring-1 ring-white/10">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={!canSubmit}
              className="w-full bg-white font-semibold text-primary hover:bg-white/90 disabled:opacity-40"
            >
